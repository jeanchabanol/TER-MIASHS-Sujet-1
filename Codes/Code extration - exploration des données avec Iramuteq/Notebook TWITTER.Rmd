...
dt3[,suicide:=T]
#On enlève les liens
dt3[,texte:=stringr::str_replace_all(texte,"https://t.co/[:alnum:]{1,}[:space:]*","")][,texte:=stringr::str_replace_all(texte,"@([[:alnum:]]+)([[:space:]]?)","")][,texte:=stringr::str_replace_all(texte,"\n","")][,texte:=stringr::str_replace_all(texte,"\t","")]
...
#On enlève les liens
#On enlève les liens
dt6[,texte:=stringr::str_replace_all(texte,"https://t.co/[:alnum:]{1,}[:space:]*","")][,texte:=stringr::str_replace_all(texte,"@([[:alnum:]]+)([[:space:]]?)","")][,texte:=stringr::str_replace_all(texte,"\n","")][,texte:=stringr::str_replace_all(texte,"\t","")]
